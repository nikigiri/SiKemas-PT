    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tambah kategori baru untuk KWT kamu</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-10 bg-gradient-to-br from-green-50 via-white to-green-100 min-h-screen">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                ...
                <form method="POST" action="{{ route('kwt-admin.kategori.store') }}">
                    @csrf
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}"
                                ...
                                placeholder="Contoh: Kerajinan Tangan" required>
