        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Kelola kategori produk KWT kamu</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Kategori khusus KWT kamu</p>
                    </div>
                    <a href="{{ route('kwt-admin.kategori.create') }}"
                    ...
                    <div class="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition duration-300">
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <div class="w-14 h-14 rounded-2xl bg-gradient-to-r from-pink-400 to-rose-500 flex items-center justify-center shadow-lg">
                                ...
                                <span class="bg-pink-100 text-pink-700 text-xs px-4 py-2 rounded-2xl font-semibold">Kategori KWT</span>
                            </div>
                            <div class="mt-5">
                        ...
                        <div class="p-5 flex items-center gap-3">
                            <a href="{{ route('kwt-admin.kategori.edit', $kategori->id) }}"
                            ...
                            <form method="POST" action="{{ route('kwt-admin.kategori.destroy', $kategori->id) }}"
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-3xl shadow-lg border border-gray-100 px-6 py-16 text-center">
                            ...
                            <h3 class="text-2xl font-bold text-gray-700">Belum Ada Kategori</h3>
                            <p class="text-gray-400 mt-2">Tambah kategori khusus KWT kamu</p>
                        </div>
                    </div>
                @endforelse
            </div>
