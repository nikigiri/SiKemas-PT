                    ...
                    <div class="flex gap-6">
                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="tagline" class="block mt-1 w-full" type="text" name="tagline" :value="old('tagline', $produk->tagline)" />
                            ...
                            <div>
                                ...
                                <textarea id="deskripsi_produk" name="deskripsi_produk" rows="4" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
                            ...
                            <div>
                                ...
                                <select id="kategori_produk" name="kategori_produk" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Elektronik" {{ old('kategori_produk', $produk->kategori_produk) == 'Elektronik' ? 'selected' : '' }}>Elektronik</option>
                                    <option value="Lainnya" {{ old('kategori_produk', $produk->kategori_produk) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                        ...
                        <div class="w-64">
                            ...
                            <div class="mt-1 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-indigo-400" onclick="document.getElementById('gambar_logo').click()">
                                @if ($produk->gambar_logo)
                                    <img id="preview" src="{{ asset('storage/' . $produk->gambar_logo) }}" alt="Preview" class="mx-auto mb-2 max-h-32 object-contain">
                                @else
                                ...
                                @endif
                                <p class="mt-2 text-sm text-gray-500">Klik untuk Ganti Gambar</p>
