<x-app-layout>
    ...
    document.getElementById('formGenerate').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('{{ url("/generate-ai") }}', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    jenis_kemasan_id: formData.get('jenis_kemasan_id'),
                    palet_warna_id: formData.get('palet_warna_id'),
                })
            });
            ...
            if (result.success) {
                resultArea.className = 'mb-5 p-5 border border-emerald-200 bg-emerald-50 rounded-2xl text-emerald-800 text-sm';
                ...
                resultArea.innerHTML = `
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <span class="font-semibold text-emerald-700">Hasil Ide Desain AI</span>
                    </div>
            ...
            resultArea.className = 'mb-5 p-5 border border-red-200 bg-red-50 rounded-2xl text-red-700 text-sm';
            resultArea.innerHTML = `
