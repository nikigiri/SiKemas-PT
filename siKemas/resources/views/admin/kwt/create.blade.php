            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <form method="POST" action="{{ route('admin.kwt.store') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_kwt" class="block mt-1 w-full" type="text" name="nama_kwt" :value="old('nama_kwt')" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="no_kwt" class="block mt-1 w-full" type="text" name="no_kwt" :value="old('no_kwt')" />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="alamat_kwt" name="alamat_kwt" rows="3"
                                  class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ old('alamat_kwt') }}</textarea>
