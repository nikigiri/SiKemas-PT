    ...
    <div class="py-10 bg-gradient-to-br from-green-50 via-white to-green-100 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <!-- Card Header -->
                <div class="bg-gradient-to-r from-pink-400 to-rose-500 px-8 py-6 flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white">Edit Data Kategori</h3>
                        <p class="text-pink-100 text-sm mt-0.5">Ubah detail kategori produk di bawah ini</p>
                    </div>
                </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <x-text-input
                                    id="nama_kategori"
                                    class="block w-full pl-11 pr-4 py-3 border border-gray-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-pink-400 focus:border-transparent transition"
                                    type="text"
                                    name="nama_kategori"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="block w-full px-4 py-3 border border-gray-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-pink-400 focus:border-transparent transition resize-none text-sm text-gray-700 placeholder-gray-400">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
